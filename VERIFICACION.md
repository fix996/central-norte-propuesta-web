...
- Plantel: filtro de arqueros muestra dos nombres, ficha individual abre correctamente, Escape cierra y devuelve el foco a la tarjeta.
- Contacto: datos de prueba `example.com`, validación de campos y mensaje demostrativo. No existe envío a servidor ni almacenamiento.
- Menú móvil: 12 accesos, abre/cierra y se cierra al navegar a la tienda.
- Escudos preservan proporciones mediante `object-fit: contain`. Fotografías de archivo identificadas como tales.
- Socios/entradas: destino OurClub. WhatsApp: se verificaron número y href sin enviar mensajes.
- No se incluyeron formularios de pago ni documentos institucionales inventados. Descargas no disponibles de prensa se muestran deshabilitadas y explicadas.

Los partidos, tabla y plantel son una instantánea fechada, no información en vivo. La revisión de accesibilidad es manual: estructura semántica, nombres de controles, teclado, foco y estados; no equivale a una certificación WCAG.
